		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				...
				<div class="carousel-caption">
					<h1><b>MIPA/MATEMATIKA IPA</b> </h1>
					<p>adalah satu bidang kejuruan yang memfokuskan pembelajaran terkait mata pelajaran ilmu pengetahuan alam dan matematika.</p>
				</div>
			</div>
			<div class="item">
				...
				<div class="carousel-caption">
					<h1><b>MIPA/MATEMATIKA IPA</b> </h1>
					<p>secara konvensional jurusan-jurusan didalam payung bidang ini terdiri dari matematika, fisika, dan biologi</p>
				</div>
			</div>
			<div class="item">
